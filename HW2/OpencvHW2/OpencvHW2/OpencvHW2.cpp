...
BEGIN_MESSAGE_MAP(COpencvHW2App, CWinApp)
...
// 僅有的一個 COpencvHW2App 物件

COpencvHW2App theApp;


// COpencvHW2App 初始設定

BOOL COpencvHW2App::InitInstance()
{
